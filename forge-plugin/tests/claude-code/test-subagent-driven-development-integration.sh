...
mkdir -p src test .forge/plans

# Create a simple implementation plan
cat > .forge/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at .forge/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at .forge/plans/implementation-plan.md using the subagent-driven-development skill.
...
echo "================================================================================"
cd "$SCRIPT_DIR/../.." && timeout 1800 claude -p "$PROMPT" --plugin-dir "$FORGE_PLUGIN_DIR" --allowed-tools=all --add-dir "$TEST_PROJECT" --permission-mode bypassPermissions 2>&1 | tee "$OUTPUT_FILE" || {
    echo ""
    echo "================================================================================"
