---
name: code-cleanup
description: "Use proactively when the user wants to clean up or refactor a codebase — even grumbling about mess counts. RU: 'почисти', 'причеши', 'разгреби', 'наведи порядок', 'упрости', 'говнокод', 'лапша', 'бардак в коде', 'технический долг', 'рефактор'. EN: 'clean up', 'refactor', 'tidy', 'technical debt', 'dead code'. Also on symptoms: dead code, unused imports, naming mix, 40+ line functions, copy-paste, before a release/handoff. Scans with parallel agents, produces a severity report, fixes ONLY after explicit approval."
---
