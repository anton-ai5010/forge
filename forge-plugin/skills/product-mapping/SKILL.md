...
description: "Use proactively when the user needs a bird's-eye view of an unfamiliar or half-forgotten project. RU: 'карта проекта', 'обзор', 'покажи структуру', 'из чего состоит', 'полная картина', 'навигатор'. EN: 'product map', 'project overview', 'big picture'. Produces an interactive HTML navigator (Картина / Потоки / Детали / Дыры) explaining the project as a business mechanism in human language, not a file tree."
---
