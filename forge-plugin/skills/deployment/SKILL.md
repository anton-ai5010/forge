---
name: deployment
description: "Use during plan/execute when the step involves shipping to production, CI/CD, Docker, hosting choice, rollback, or a release. RU: 'задеплой', 'на прод', 'выложи', 'залей на сервер', 'докер', 'выкат', 'релиз', 'опубликуй', 'откат', 'хелсчек'. EN: 'deploy', 'ship it', 'go live', 'production', 'Dockerfile', 'CI/CD', 'rollback', 'health check'. Ensures a rollback strategy and health checks before any push — even a 'small' one."
---
