> ⚠️ **Исторический документ** (эпоха 4-фазного пайплайна, ≤v7.0). НЕ действующая спецификация — не читать как источник правды. Актуальное состояние — CLAUDE.md и README.
